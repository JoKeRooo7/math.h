...
Реализованы только те функции библиотеки math.h что непосредственно описаны [выше](#обзор-некоторых-функций-mathh):
